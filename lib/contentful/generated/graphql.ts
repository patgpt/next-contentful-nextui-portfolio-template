...
export type AuthorLinkingCollectionsPostCollectionArgs = {
  ...
  locale?: InputMaybe<Scalars["String"]["input"]>;
  order?: InputMaybe<
    Array<InputMaybe<AuthorLinkingCollectionsPostCollectionOrder>>
  >;
  preview?: InputMaybe<Scalars["Boolean"]["input"]>;
  skip?: InputMaybe<Scalars["Int"]["input"]>;
};
...
export type GetAllPostsQuery = {
  ...
  postCollection?: {
    ...
    items: Array<{
      ...
      content?: { __typename?: "PostContent"; json: any } | null;
    } | null>;
  } | null;
};
...
export function getSdk(
  ...
  return {
    getAllPosts(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAllPostsQuery>(GetAllPostsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getAllPosts",
    ...
    getPostBySlug(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPostBySlugQuery>(GetPostBySlugDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getPostBySlug",
